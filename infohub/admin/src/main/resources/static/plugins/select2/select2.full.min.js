    ...
    var b = function () {
        ...
        return function () {
            ...
            return a.Extend(b, a.Observable), b.prototype.current = function (a) {
                ...
                throw new Error("The `query.css` method must be defined in child classes.")
            ...
            return b.prototype.append = function (a, b) {
                ...
                }), c.on("query.css:append", function (a) {
                    e.lastParams = a, e.loading = !0
                ...
                b.page++, this.trigger("query.css:append", b)
            ...
            return D.prototype.apply = function (l) {
                if (l = a.extend(!0, {}, this.defaults, l), null == l.dataAdapter) {
                    if (null != l.ajax ? l.dataAdapter = o : null != l.data ? l.dataAdapter = n : l.dataAdapter = m, l.minimumInputLength > 0 && (l.dataAdapter = j.Decorate(l.dataAdapter, r)), l.maximumInputLength > 0 && (l.dataAdapter = j.Decorate(l.dataAdapter, s)), l.maximumSelectionLength > 0 && (l.dataAdapter = j.Decorate(l.dataAdapter, t)), l.tags && (l.dataAdapter = j.Decorate(l.dataAdapter, p)), null == l.tokenSeparators && null == l.tokenizer || (l.dataAdapter = j.Decorate(l.dataAdapter, q)), null != l.query) {
                        var C = b(l.amdBase + "compat/query.css");
            ...
            return c.Extend(e, c.Observable), e.prototype._generateId = function (a) {
                ...
                }), this.on("query.css:append", function (b) {
            ...
            function a(a, b, c) {
                c.get("debug") && window.console && console.warn && console.warn("Select2: The `query.css` option has been deprecated in favor of a custom data adapter that overrides the `query.css` method. Support will be removed for the `query.css` option in future versions of Select2."), a.call(this, b, c)
            }
